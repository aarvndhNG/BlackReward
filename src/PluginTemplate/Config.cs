...
namespace AVote
{
	public class Config
	{
		public List<string> Commands = new List<string>() { "/firework %PLAYER% " };
        ...
        public void Write()
		{
			string path = Path.Combine(TShock.SavePath, "BlackRewards.json");
			File.WriteAllText(path, JsonConvert.SerializeObject(this, Formatting.Indented));
		}
		public static Config Read()
		{
			string filepath = Path.Combine(TShock.SavePath, "BlackRewards.json");
